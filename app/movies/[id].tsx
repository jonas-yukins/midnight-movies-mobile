    ...
    <View className='flex-1 bg-primary'>
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <MovieInfo label='Production Countries' value={movie?.production_countries.map((c) => c.name).join(', ') || 'N/A'} />
      ...
      <TouchableOpacity
        ...
        onPress={router.back}
      >
        <Image source={icons.arrow} className='size-5 mr-5 mt-0.5 rotate-180' tint='#fff' />
